                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Contoh : Fazeel" value="{{ old('name') }}" autofocus />
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="phone"
                                        ...
                                        placeholder="Contoh : 08xxxx" value="{{ old('phone') }}" autofocus />
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="email"
                                        ...
                                        placeholder="Contoh : Fazeel@gmail.com" value="{{ old('email') }}" autofocus />
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
