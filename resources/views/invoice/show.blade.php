            ...
            <div class="col-lg-12 col-12 mb-lg-0 mb-4">
                <div class="card invoice-preview-card">
                    <div class="card-body">
                        <div class="row p-sm-3 p-0">
                            <div class="col-md-6 mb-md-0 mb-4">
                                <div class="d-flex svg-illustration mb-4 gap-2">
                                    ...
                                    <span
                                        class="app-brand-text demo text-body fw-bold text-uppercase">{{ $invoice->tenant->name }}</span>
                                </div>
                                    ...
                                    <dd class="col-sm-6 d-flex justify-content-md-end">
                                        <div class="w-px-200">
                                            <input type="text" class="form-control" disabled=""
                                                value="{{ $invoice->invoice_number }}" id="invoiceId">
                                        </div>
                                    </dd>
                                    <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end">
                                        <span class="fw-normal">Transaction Date:</span>
                                    </dt>
                                    <dd class="col-sm-6 d-flex justify-content-md-end">
                                        <div class="w-px-200">
                                            <input type="text" class="form-control date-picker flatpickr-input"
                                                placeholder="YYYY-MM-DD" readonly="readonly"
                                                value="{{ \Carbon\Carbon::parse($invoice->transaction_date)->format('d M Y, H:i:s') }}">
                                        </div>
                                    </dd>
                        ...
                        <hr class="mx-n4">
                        <a href="{{ route('invoices.index') }}" class="btn btn-warning">Kembali</a>
